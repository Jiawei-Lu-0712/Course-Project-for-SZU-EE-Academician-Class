...
import gym
# !pip install gymnasium[box2d] box2d
...
def parse_args():
    ...
    parser.add_argument("--exp-name", type=str, default="notebook",
        help="the name of this experiment")
    ...
    # 如果在 Jupyter Notebook 中运行，忽略未知参数
...
if __name__ == "__main__":
    ...
    print(f"模型已保存到: models/{run_name}.pt")